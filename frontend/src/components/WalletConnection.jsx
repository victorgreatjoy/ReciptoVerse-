        ...
        <div className="wallet-info">
          <div className="wallet-status">
            <div className="wallet-icon">
              ...
              <span className="wallet-name">{selectedWallet?.name || "Wallet"}</span>
            </div>
    ...
    <div className="wallet-connection">
      <div className="wallet-section">
        ...
        <p className="wallet-subtitle">
          Choose your preferred wallet to connect to ReciptoVerse
        </p>
        ...
        <div className="wallet-options">
          {availableWallets.length > 0 ? (
            availableWallets.map((wallet) => (
              <div key={wallet.id} className="wallet-option">
                <button
                  ...
                  className={`wallet-btn ${wallet.type === 'install' ? 'install-btn' : ''}`}
                ...
                >
                  <div className="wallet-btn-content">
                    <div className="wallet-icon-container">
                      ...
                      />
                      <div className="wallet-icon-fallback" style={{ display: 'none' }}>
                        💳
                      </div>
                    </div>
            ...
            <div className="no-wallets">
              ...
              <h4>Scanning for Wallets...</h4>
              <p>Please wait while we detect available wallet extensions.</p>
